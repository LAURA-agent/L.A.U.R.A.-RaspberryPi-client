...
# ========== Paths ==========
BASE_PATH = Path("/home/user/RP500-Client")
SOUND_BASE_PATH = BASE_PATH / "sounds"

DISPLAY_SVG_PATH_DEFAULT = BASE_PATH / "svg files/silhouette.svg"
DISPLAY_BOOT_IMG_PATH_DEFAULT = BASE_PATH / "images/laura/boot/interested01.png"
...
WAKEWORD_MODEL_DIR_DEFAULT = BASE_PATH / "wakewords"
...
WAKE_WORDS_AND_SENSITIVITIES_DEFAULT = {
    ...
    "Laura.pmdl": 0.45,
    "tookmycrazypills.pmdl": 0.5,
    "claudecode.pmdl": 0.5,
    "sendnote.pmdl": 0.5,  # Wake word for Pi500 note transfer to Mac
}
...
VOSK_MODEL_PATHS_AVAILABLE = {
    ...
    "medium": str(VOSK_MODELS_BASE_PATH / "vosk-model-en-us-0.22"), # Your medium model path
    "large": str(VOSK_MODELS_BASE_PATH / "vosk-model-en-us-0.42"), # Example if you have it
    # Add other Vosk models here if you have them, e.g., "en-in" for Indian English
}
VOSK_MODEL_SIZE_DEFAULT = "medium" # Set your preferred default size here


# ========== Device/Server & Misc ==========
DEVICE_ID_DEFAULT = "Pi500-og"
...
_DEFAULT_CLIENT_SETTINGS = {
    ...
    "vad_settings": {
        ...
        "continued_threshold_ratio": 0.65,
        "silence_duration": 2.0,
        "min_speech_duration": 0.3,
        "speech_buffer_time_s": 0.2,
        "frame_history_length": 10,
        "initial_listen_timeout_s": 7.0,
        "follow_up_initial_listen_timeout_s": 5.0,
        "max_recording_time": 30.0,
        "follow_up_max_recording_time_s": 20.0,
        "vosk_reject_min_words": 1,
        "vosk_reject_min_chars_if_single_word": 3
    },
    "_default_config": {}
}
